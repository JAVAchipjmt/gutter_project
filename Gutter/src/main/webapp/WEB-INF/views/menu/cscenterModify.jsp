	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-danger">
				<div class="panel-heading"><h5>문의 수정하기</h5></div>
				<div class="panel-body">
				<br>
		<div class="panel-body">
			<form role="form" action="/menu/cscenterModify" method="post">
	     		<!-- 보안 관련 추가 -->					
				<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
				<div class="form-group">
					<input type="text" id="title" name="title" class="form-control" name="title"
					 value='<c:out value="${cscenter.title}"/>'>
				</div>
				<br>
				<div class="form-group">
					<input type="text" name="content" id="content" name="content" class="form-control"
					 value='<c:out value="${cscenter.content}"/>'>
				</div>
				<br>
				<div class="form-group">
...
$(document).ready(function(){
	...
	$("button").on("click",function(e){
		...
		//삭제 버튼을 클릭시 처리
		if(operation === "remove"){
			formObj.attr("action","/menu/cscenterRemove");
			formObj.submit();
