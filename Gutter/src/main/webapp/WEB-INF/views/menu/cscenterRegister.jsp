...
<head>
<meta charset="UTF-8">
<title>CS Center Register</title>
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-danger">
				...
				<br>
		<div class="panel-body">
			<form role='form' action="/menu/cscenterRegister" id="form_cscenterRegister" method="post">
				<!-- 보안 관련 추가 -->					
				<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
	     		
				<div class="form-group">
					<input type="text" id="title" name="title" class="form-control" name="title" placeholder="제목은 50 자 이내로 작성해 주세요.">
				</div>
				<br>
				<div class="form-group">
					<textarea name="content" id="content" name="content" class="form-control"
								    rows="3" cols="50" placeholder="내용은 150 자 이내로 작성해 주세요. 문의는 편하게 남겨 주시면 되고 신고의 경우 해당 게시물이나 댓글 캡처를 첨부해 주세요."></textarea>
				</div>
				<br>
				<div class="form-group">
...
$(document).ready(function(){
	...
	$("input[type='file']").change(function(e) {
		...
		$.ajax({
			url : "/menu/cscenterRegister/uploadAjaxAction",
			type : "post",
	...
	$(".uploadResult").on("click","button",function(e){
		...
		$.ajax({
			url: "/menu/cscenterRegister/deleteFile",
			type: "post",
			//URL의 매개변수를 지정하는 속성
	...
	function showUploadResult(uploadResultArr) {
		...
		$(uploadResultArr).each(function(i, obj) {
							...
							if (!obj.image) {
								...
								str += "<img src='/menu/cscenterGet/display?fileName="
										+ fileCallPath + "'>";
								str += "</div>";
								str += "</li>";
							}
