	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-danger">
				<div class="panel-heading"><h5>Photo</h5></div>
			...
			<form id="form_cscenterRegister" method="post">
				...
				<div class="form-group">
					<input type="text" id="title" name="title" class="form-control" name="title"
					 value='<c:out value="${photo.title}"/>' readonly="readonly">
				</div>
				<br>
				<div class="form-group">
					<input type="text" name="content" id="content" name="content" class="form-control"
					 value='<c:out value="${photo.content}"/>' readonly="readonly">
				</div>
				<br>
				<div class="form-group">
...
<script src="/resources/dist/js/photoReply.js"></script>
<script>
$(document).ready(function(){
			...
			$.getJSON("/squeak/photoGet/getAttachList",{bno: bno},function(arr){
				...
				$(arr).each(function(i,attach){
					...
					if(attach.fileType){
						...
						str += "<img src='/squeak/photoGet/display?fileName="+fileCallPath+"'>";
						str += "</div>";
						str += "</li>";
	...
	$(".uploadResult").on("click","li",function(e){
		...
		if(liObj.data("type")){
			...
			self.location = "/squeak/photoGet/download?fileName=" + path;
		}
	});//
	...
	function showImage(fileCallPath){
		...
		$(".bigPicture").html("<img src='/squeak/photoGet/display?fileName=" + fileCallPath + "'>")
	...
	$("button[data-oper='modify']").on("click",function(e){
		operForm.attr("action","/squeak/photoModify")
		        .submit();
	});
	
	//목록 버튼을 클릭시 처리
	$("button[data-oper='list']").on("click",function(e){
		operForm.attr("action","/squeak/photoList")
		        .submit();
	});
