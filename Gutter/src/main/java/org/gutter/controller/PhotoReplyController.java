...
import org.gutter.service.PhotoReplyService;
...
public class PhotoReplyController {
	...
	private PhotoReplyService service;
	
//	신규 댓글 등록
	@PreAuthorize("isAuthenticated()")
	@PostMapping(value = "/photoGet/new",
...
//		@RequestBody: json 형태의 데이터를 자바 클래스 형태로 매핑
	...
	@GetMapping(value="/photoGet/reply/{bno}/{page}",
			produces = {
...
//	특정 댓글 삭제 처리
	...
	@DeleteMapping(value="/photoGet/{rno}")
...
//	PUT: 전체 수정, PATCH: 일부 수정
	@PreAuthorize("principal.username == #vo.replyer")
	@RequestMapping(value="/photoGet/{rno}",
	        //PUT : 전체항목을 수정시 사용
	        //PATCH: 일부를 수정시 사용
